...
<!-- Mirrored from bookwritingfounders.com/privacy-policy by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Mar 2021 08:21:59 GMT -->
           ...
           <div class="popupform tabform clearfix  text-left">
             ...
             <form id="popupfrm" class="cmxform"  method="POST" action="https://bookwritingfounders.com/webpages/bannerFormController.php">
               ...
               <div class="fldst">
                 ...
                 <input type="hidden" id="location" name="locationURL" value="http://bookwritingfounders.com/privacy-policy" />
              </div>
                      ...
                      <div class="col-lg-12">
                        <div class="fldset">
                          <input name="submit" type="submit" placeholder="Connect With Us" required />
                            ...
                            <input type="hidden" name="cip" >
                            <input type="hidden" id="location" name="locationURL" value="privacy-policy/" />
                        </div>
                      </div>
                    </div>
                  </form>
